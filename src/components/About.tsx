        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
              For over 20 years, Sweet Haven Bakery has been crafting
            ...
            <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
              ...
              From our signature sourdough to our decadent chocolate cakes,
          ...
          >
            ...
            <div className="bg-card p-6 rounded-lg shadow-[var(--shadow-soft)] hover-lift text-center mt-8">
              <div className="text-4xl mb-2">😊</div>
              <div className="text-3xl font-bold text-primary">50k+</div>
              <div className="text-sm text-muted-foreground">Happy Customers</div>
            </div>
            <div className="bg-card p-6 rounded-lg shadow-[var(--shadow-soft)] hover-lift text-center -mt-4">
              <div className="text-4xl mb-2">🥐</div>
